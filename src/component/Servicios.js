  ...
  <section id="services" className="services">
    <div className="container">
      ...
      <div className="row">
        ...
        <MicroServicio icono="bi bi-speedometer2" titulo="Estética" texto="El aluminio ofrece un aspecto moderno y limpio que se adapta a una variedad de estilos arquitectónicos. Además, permite diseños delgados y elegantes que maximizan la entrada de luz." delay="450" margin=""/>
        <MicroServicio icono="bi bi-speedometer2" titulo="Facilidad de mantenimiento:" texto=" Las superficies de aluminio son fáciles de limpiar y mantener, lo que es importante en aplicaciones de construcción donde se requiere un aspecto limpio y ordenado." delay="600" margin=""/>
        <MicroServicio icono="bi bi-speedometer2" titulo="Resistencia a la deformación" texto=" El aluminio conserva su forma y resistencia incluso en condiciones climáticas extremas, lo que garantiza la integridad estructural de las ventanas y puertas a lo largo del tiempo." delay="750" margin=""/>
